          ...
          <nav className="hidden lg:flex items-center gap-1">
            {navItems.map((item) => (
              <NavLink
                ...
                to={item.path}
                className={({ isActive }) =>
                  `relative px-5 py-2 rounded-full text-xs font-semibold tracking-wider transition-all duration-300 block group uppercase ${isActive
                    ? "text-white"
                ...
                {navItems.map((item, index) => (
                  ...
                  >
                    <NavLink
                      ...
                      className={({ isActive }) =>
                        `group relative flex items-center justify-between w-full py-4 text-[22px] sm:text-3xl font-black transition-all duration-300 ${isActive
                          ? "text-white pl-4"
