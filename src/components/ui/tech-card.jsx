...
export function TechCard({ tech, index }) {
    ...
    return (
        <motion.div
            ...
            className="group relative w-16 h-16 md:w-20 md:h-20 cursor-pointer z-0 hover:z-50"
        >
            ...
            <div className="absolute inset-0 rounded-full bg-slate-950 border border-white/5 overflow-hidden backdrop-blur-md shadow-[0_0_15px_rgba(0,0,0,0.5)] transition-all duration-200 group-hover:scale-105 group-hover:shadow-[0_0_30px_rgba(34,211,238,0.3)] group-hover:border-cyan-500/50">
                ...
                <div className="relative h-full w-full flex flex-col items-center justify-center transform-style-3d z-30">
                    <motion.div
                        className="text-2xl md:text-3xl transition-all duration-200 group-hover:scale-110 drop-shadow-[0_5px_5px_rgba(0,0,0,0.5)]"
            ...
            <div className="absolute -bottom-10 left-1/2 -translate-x-1/2 opacity-0 group-hover:opacity-100 transition-all duration-200 flex flex-col items-center gap-1 z-50 pointer-events-none translate-y-2 group-hover:translate-y-0 min-w-max">
