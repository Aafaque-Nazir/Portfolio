...
export const Header = () => {
  return (
    <div className="max-w-7xl relative mx-auto py-20 md:py-40 px-4 w-full left-0 top-0">
      ...
      <p className="max-w-2xl text-base md:text-xl mt-8 dark:text-neutral-200 text-gray-300">
        A curated collection of my best work, building beautiful products with
    ...
    >
      ...
      >
        <img
          ...
          // Using standard img tag but styled for cover
